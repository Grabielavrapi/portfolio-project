  ...
  return (
    <div className="container py-5">
      <div className="row">
        ...
        I found a tutorial on how to use Visual Basic to display a phone on my computer screen, and once that happened,
        I was completely hooked to the world of computers.
